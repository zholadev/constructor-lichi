...
const DocSchemaContent: React.FC = () => {
	return (
		<>
			<DocWrapperContent schema_json={schemaDocParams.doc_content_params}>
				<h2>
				...
				<p>
					...
					изображения, видео, анимации, ссылки и текст. Этот модуль
					позволяет гибко настраивать и отображать контент,
					адаптируясь к различным устройствам и добавляя интерактивные
					элементы.
				</p>
				...
				<ul>
					<li>
						...
						: <code>object</code>
						<br />
						Описывает изображения для различных устройств (десктоп,
						планшет, мобильный). Каждое изображение представлено
						отдельным объектом для конкретного разрешения экрана.
						<ul>
							<li>
								<code>desktop</code>: Изображение для десктопов.
							</li>
							<li>
								<code>tablet</code>: Изображение для планшетов.
							</li>
							<li>
								<code>mobile</code>: Изображение для мобильных
								устройств.
							</li>
						</ul>
					</li>
					...
					<li>
						...
						: <code>object</code>
						<br />
						Описывает видео-контент. Содержит ссылку на видеофайл и
						изображение постера, отображаемого перед началом
						воспроизведения.
						<ul>
							<li>
					...
					<li>
						...
						: <code>object</code>
						<br />
						Определяет параметры анимации для контента. Включает тип
						анимации и настройку отслеживания видимости элемента.
						<ul>
							<li>
								<code>type</code>: Тип анимации (например,{" "}
								<code>zoom_in</code>, <code>zoom_out</code>, или{" "}
								<code>none</code>).
							</li>
							<li>
								<code>observer</code>: Булевое значение, которое
								определяет, нужно ли отслеживать видимость
								элемента для запуска анимации.
							</li>
						</ul>
					</li>
					...
					<li>
						...
						: <code>object</code>
						<br />
						Описывает структуру ссылок, включая внешний и внутренний
						URL, а также настройки для управления поведением ссылки.
						<ul>
							<li>
								<code>href</code>:
								<ul>
									<li>
										<code>src</code>: Внешняя ссылка (URL).
									</li>
									<li>
										<code>internal_src</code>: Внутренняя
										ссылка (относительный путь).
									</li>
								</ul>
							</li>
						</ul>
					...
					<li>
						...
						Структура поддерживает локализацию через использование
						ключей для разных языков.
						<ul>
							<li>
								<code>title</code>: Заголовок, представленный
								как объект с ключами для разных языков
								(например, <code>en: value: Welcome</code>).
							</li>
						</ul>
					</li>
				</ul>
			...
			<DocWrapperContent
				schema_json={schemaDocParams.doc_content_photo_params}
			>
				<h3>
				...
				<p>
					...
					изображениями, которые адаптируются к различным устройствам
					(десктоп, планшет, мобильный). Каждое изображение имеет
					различные свойства, такие как URL, публичный URL, путь и
					информация об изображении, включая его размеры и яркость.
				</p>
					...
					<li>
						...
						<ul>
							...
							<li>
								...
								<ul>
									<li>
										<code>width</code>: Ширина изображения
										(в пикселях).
									</li>
									<li>
										<code>height</code>: Высота изображения
										(в пикселях).
									</li>
									<li>
			...
			<DocWrapperContent
				schema_json={schemaDocParams.doc_content_video_params}
			>
				<h3>
				...
				<p>
					...
					видео контентом на веб-странице. Он включает ссылку на видео
					и изображение постера, которое отображается до начала
				...
				<ul>
					<li>
						...
						: <code>object</code>
						<br />
						Описывает изображение постера для видео. Это изображение
						отображается перед воспроизведением видео.
						<ul>
							<li>
								<code>url</code>: Прямой URL изображения
								постера.
					...
					<li>
						...
						: <code>string</code>
						<br />
						Ссылка на видеофайл. В данном примере используется видео
						с платформы Vimeo. Пример значения:{" "}
			...
			<DocWrapperContent
				schema_json={schemaDocParams.doc_content_text_params}
			>
				<h3>
				...
				<p>
					...
					текстовыми заголовками с поддержкой нескольких языков. Он
					предоставляет значения заголовков на различных языках, таких
					как английский, арабский, немецкий, польский, французский и
					русский.
				</p>
				...
				<ul>
					...
					<li>
						...
						<ul>
							<li>
								<code>value</code>: Текст заголовка на арабском
								языке. Пример: <code>Арабский</code>.
							</li>
						</ul>
					</li>
					...
					<li>
						...
						<ul>
							<li>
								<code>value</code>: Текст заголовка на немецком
								языке. Пример: <code>Немецкий</code>.
							</li>
						</ul>
					</li>
					...
					<li>
						...
						<ul>
							<li>
								<code>value</code>: Текст заголовка на польском
								языке. Пример: <code>Польский</code>.
							</li>
						</ul>
					</li>
					...
					<li>
						...
						<ul>
							<li>
								<code>value</code>: Текст заголовка на русском
								языке. Пример: <code>Русский</code>.
							</li>
						</ul>
					</li>
				</ul>
			...
			<DocWrapperContent
				schema_json={schemaDocParams.doc_content_link_params}
			>
				<h3>
				...
				<ul>
					<li>
						...
						: <code>object</code>
						<br />
						Описывает ссылки, которые содержат внешний и внутренний
						URL.
						<ul>
							<li>
